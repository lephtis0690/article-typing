...
const rhythmIndicatorModeSelect = document.getElementById('rhythm-indicator-mode');
...
const btnPreviewTenSec = document.getElementById('btn-preview-ten-sec');
const btnPreviewStartWhistle = document.getElementById('btn-preview-start-whistle');
const btnPreviewFinishWhistle = document.getElementById('btn-preview-finish-whistle');
...
const updateInfoList = document.getElementById('update-info-list');
const advancedSettings = document.getElementById('advanced-settings');
const disqualifyLimitSelect = document.getElementById('disqualify-limit');
const btnStart        = document.getElementById('btn-start');
const btnAbort        = document.getElementById('btn-abort');
const btnRetry        = document.getElementById('btn-retry');
const btnRetryTop     = document.getElementById('btn-retry-top');
const btnRetryRandom  = document.getElementById('btn-retry-random');
const btnRetryRandomTop = document.getElementById('btn-retry-random-top');
const btnBackConfig   = document.getElementById('btn-back-config');
const btnBackConfigTop = document.getElementById('btn-back-config-top');
const btnShareX       = document.getElementById('btn-share-x');
const resultActionNote = document.getElementById('result-action-note');
...
const btnOpenCpmScreen = document.getElementById('btn-open-cpm-screen');
const btnOpenInputCompareScreen = document.getElementById('btn-open-input-compare-screen');
const btnOpenScoringDetailScreen = document.getElementById('btn-open-scoring-detail-screen');
const cpmScreen = document.getElementById('cpm-screen');
const inputCompareScreen = document.getElementById('input-compare-screen');
const scoringDetailScreen = document.getElementById('scoring-detail-screen');
const btnCpmBack = document.getElementById('btn-cpm-back');
const btnCpmHome = document.getElementById('btn-cpm-home');
const btnInputCompareBack = document.getElementById('btn-input-compare-back');
const btnInputCompareHome = document.getElementById('btn-input-compare-home');
const btnScoringDetailBack = document.getElementById('btn-scoring-detail-back');
const btnScoringDetailHome = document.getElementById('btn-scoring-detail-home');
...
const btnRecordBackBottom = document.getElementById('btn-record-back-bottom');
const btnRecordHomeBottom = document.getElementById('btn-record-home-bottom');
const btnRecordResetBottom = document.getElementById('btn-record-reset-bottom');
...
const cpmChartDisplayMode = document.getElementById('cpm-chart-display-mode');
...
const chartCurrentMovingCpm = document.getElementById('chart-current-moving-cpm');
...
const recordCurrentBadge = document.getElementById('record-current-badge');
const recordCurrentCpm = document.getElementById('record-current-cpm');
const recordCurrentAccuracy = document.getElementById('record-current-accuracy');
const recordCurrentError = document.getElementById('record-current-error');
const recordCurrentTask = document.getElementById('record-current-task');
const recordCurrentMeta = document.getElementById('record-current-meta');
...
const recordGraphMetric = document.getElementById('record-graph-metric');
const recordLineChart = document.getElementById('record-line-chart');
const recordGraphTitle = document.getElementById('record-graph-title');
const recordGraphNote = document.getElementById('record-graph-note');
const recordGraphLegend = document.getElementById('record-graph-legend');
...
const inputCompareView    = document.getElementById('input-compare-view');
const inputCompareNote    = document.getElementById('input-compare-note');
const btnCompareContext   = document.getElementById('btn-compare-context');
const btnCompareFull      = document.getElementById('btn-compare-full');
const btnComparePrev      = document.getElementById('btn-compare-prev');
const btnCompareNext      = document.getElementById('btn-compare-next');
const inputCompareCounter = document.getElementById('input-compare-counter');
const typingTraitSummary  = document.getElementById('typing-trait-summary');
const typingTraitName     = document.getElementById('typing-trait-name');
const typingTraitComment  = document.getElementById('typing-trait-comment');
const typingTraitTags     = document.getElementById('typing-trait-tags');
const longDiagnosisSummary = document.getElementById('long-diagnosis-summary');
const longDiagnosisList    = document.getElementById('long-diagnosis-list');
const longDiagnosisTakeaways = document.getElementById('long-diagnosis-takeaways');
const longDiagnosisComment = document.getElementById('long-diagnosis-comment');
const longDiagnosisSupport = document.getElementById('long-diagnosis-support');
